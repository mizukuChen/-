...
#define EnX_Pin GPIO_PIN_8
#define EnX_GPIO_Port GPIOC
#define EnY_Pin GPIO_PIN_9
#define EnY_GPIO_Port GPIOC
#define DirX_Pin GPIO_PIN_8
#define DirX_GPIO_Port GPIOA
#define DirY_Pin GPIO_PIN_9
#define DirY_GPIO_Port GPIOA
#define StpX_Pin GPIO_PIN_10
#define StpX_GPIO_Port GPIOA
#define StpY_Pin GPIO_PIN_11
